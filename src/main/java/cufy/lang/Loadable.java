...
public interface Loadable {
	 ...
	 */
	InputStream getInputStream(Instructor instructor) throws IOException;
	 ...
	 * @throws NullPointerException if the given instructor is null
	 */
	OutputStream getOutputStream(Instructor instructor) throws IOException;
	 ...
	 * @throws NullPointerException if the given instructor is null
	 */
	Reader getReader(Instructor instructor) throws IOException;
	 ...
	 * @throws NullPointerException if the given instructor is null
	 */
	Writer getWriter(Instructor instructor) throws IOException;
